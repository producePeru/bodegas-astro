  ...
  <div class="bg-white rounded-2xl shadow-lg border border-neutral-200 p-6 md:p-8">
    ...
    <form v-if="!enviado" @submit="enviar" novalidate class="space-y-4">
      ...
      <div>
        ...
        <input id="celular" v-model="celular" type="tel" placeholder="+51 999 999 999"
          class="w-full px-4 py-2.5 rounded-lg border border-neutral-300 focus:border-[#00a6db] focus:ring-2 focus:ring-[#00a6db]/20 outline-none transition" />
      </div>

      <div>
        <label for="correo" class="block text-sm font-medium text-neutral-700 mb-1">Correo electrónico</label>
        <input id="correo" v-model="correo" type="email" placeholder="tucorreo@ejemplo.com"
          class="w-full px-4 py-2.5 rounded-lg border border-neutral-300 focus:border-[#00a6db] focus:ring-2 focus:ring-[#00a6db]/20 outline-none transition" />
      </div>

      <div>
        <label for="producto" class="block text-sm font-medium text-neutral-700 mb-1">Indicar producto de
          interés</label>
        <input id="producto" v-model="producto" type="text" placeholder="Ej: Vino tinto, Lavadora, Zapatos..."
          class="w-full px-4 py-2.5 rounded-lg border border-neutral-300 focus:border-[#00a6db] focus:ring-2 focus:ring-[#00a6db]/20 outline-none transition" />
      </div>
    ...
    <div v-else class="text-center py-10">
      ...
      <button type="button" @click="enviado = false; nombre = ''; celular = ''; correo = ''; producto = ''"
